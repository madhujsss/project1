...
const CustomerInfo = () => {
  return (      
    ...
    <div className="mt-10">
     <Link style={{textDecoration: 'none', opacity:"1", }}  to={"/restaurant/next/payment"}>
      <button type="submit" className="mb-10 block w-full rounded-md bg-indigo-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Complete your order</button>
      </Link>
    </div>
    </form>
    </div>
