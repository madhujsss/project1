...
const CustomerInfo = () => {
  return (      
      <div >
    <form className="h-50 mt-10 ml-10 mr-10 w-90"> 
      ...
      <div className="sm:col-span-2">
        ...
        <div className="mt-2.5">
          <textarea rows="2" className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
        </div>
      </div>
